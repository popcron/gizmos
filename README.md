![Ah, gl lines](Splash.png)

# Gizmos

Used for drawing gizmos in either builds or the editor, as the built in gizmos API by Unity only does so in the editor. With some extra features.
